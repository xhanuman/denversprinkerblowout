...
function showConfirmationCard(formattedAddress, meta, acuityUrl) {
    ...
    card.innerHTML = [
        ...
        '</p>',
        '<p style="font-size:14px;color:#596570;margin-bottom:8px;">',
        'Service area: <strong>', escapeHtml(meta.name), '</strong>',
        '</p>',
        '<p style="font-size:12px;color:#888;margin-bottom:20px;">',
        'You&rsquo;ll be asked to enter your address again in the next step &mdash; please use the same address shown above.',
        '</p>',
